...
A load-bearing claim drawn from a law still goes through the flow's own `transparent-thinking:note_key_facts` / `transparent-thinking:note_assumptions`, worded so its own prose says which law it came from.
